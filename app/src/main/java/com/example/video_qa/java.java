...
public class java extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        play.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(java.this,add_video.class);
            ...
            Task<Uri> urltask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    ...
                    if(task.isSuccessful()){
                        ...
                        Toast.makeText(java.this,"Video Uploaded",Toast.LENGTH_SHORT).show();
                        videomodel.setDesc("This is a sample video for the Java Space");
                        videomodel.setTitle("Java Sample Video");
                        videomodel.setUrl(downloadurl.toString());
                        String i = databaseReference.push().getKey();
                        databaseReference.child(i).setValue(videomodel);
                    }
                    else{
                        Toast.makeText(java.this,"Video Failed",Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
