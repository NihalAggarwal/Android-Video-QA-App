...
public class blockchain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        play.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(blockchain.this,add_video_blockchain.class);
            ...
            Task<Uri> urltask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    ...
                    if(task.isSuccessful()){
                        ...
                        Toast.makeText(blockchain.this,"Video Uploaded",Toast.LENGTH_SHORT).show();
                        videomodel.setDesc("This is a sample video for the Blockchain Space");
                        videomodel.setTitle("Blockchain Sample Video");
                        videomodel.setUrl(downloadurl.toString());
                        String i = databaseReference.push().getKey();
                        databaseReference.child(i).setValue(videomodel);
                    }
                    else{
                        Toast.makeText(blockchain.this,"Video Failed",Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
